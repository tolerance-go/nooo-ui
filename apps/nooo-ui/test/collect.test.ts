...
describe('collect', async () => {
   ...
   //      </div>
   //      ",
   //        "key": "widgets/app/button/button-1",
   //        "meta": {
   //          "center": true,
